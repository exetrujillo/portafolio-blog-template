...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "572b46ef-6431-4288-b6bc-2371c922e4d1",
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/__nuxt_content/portfolio/sql_dump": {
        "prerender": true
      },
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "C:/Users/Administrator/Documents/Nuxt/NuevApp/nuxt-code-editor/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "icon": {
...
const _F_0L7kYT86exaWsOoAyudDIaLUk9cXB37N668AJwDr8 = (function(nitro) {
...
const plugins = [
  _F_0L7kYT86exaWsOoAyudDIaLUk9cXB37N668AJwDr8
];
...
const checksums = {
  "portfolio": "v3.5.0--eWgA2L-qmht44KzUj4rcjtEJq6qp2WaYzvtekErqtsU",
  "blog": "v3.5.0--v_d0fvp9Ekf7uILpZYOlb3Bc8KRQ_4cAkD_bd8sZ-Co"
};
const checksumsStructure = {
  "portfolio": "Lbgguofj5aufCaJxuvWSWgv_DE9TS9bZPUaBaBgwf00",
  "blog": "xZQdoRdXaSQ9o-xzf2VRP8I2L8QYJWGp-fU9s-9ZP2E"
};
const tables = {
  "portfolio": "_content_portfolio",
  "blog": "_content_blog",
  "info": "_content_info"
};
...
const _lAkbP3 = defineCachedEventHandler(async (event) => {
...
const _i_I0gi = eventHandler(async (event) => {
...
const _e_RI1J = eventHandler(async (event) => {
...
const _Yel99p = lazyEventHandler(() => {
...
const _lazy_KusLtg = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_KusLtg, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _lAkbP3, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump', handler: _i_I0gi, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _e_RI1J, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _Yel99p, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_KusLtg, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, parseURL as A, baseURL as B, createHooks as C, executeAsync as D, toRouteMatcher as E, createRouter$1 as F, encodeParam as G, encodePath as H, pascalCase as I, kebabCase as J, destr as K, useRuntimeConfig as a, buildAssetsURL as b, getResponseStatus as c, defineRenderHandler as d, publicAssetsURL as e, getQuery as f, getResponseStatusText as g, createError$1 as h, getRouteRules as i, defuFn as j, klona as k, defu as l, hasProtocol as m, joinURL as n, getContext as o, parseQuery as p, isEqual as q, withTrailingSlash as r, serialize$1 as s, toNodeListener as t, useNitroApp as u, withoutTrailingSlash as v, withQuery as w, isScriptProtocol as x, sanitizeStatusCode as y, withLeadingSlash as z };
