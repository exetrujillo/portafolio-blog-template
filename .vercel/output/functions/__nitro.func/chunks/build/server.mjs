import { defineComponent, ref, h, resolveComponent, computed, toValue, getCurrentInstance, onServerPrefetch, useAttrs, mergeProps, unref, hasInjectionContext, inject, defineAsyncComponent, watch, withCtx, createVNode, resolveDynamicComponent, renderSlot, createBlock, openBlock, toDisplayString, Suspense, shallowRef, toRef, provide, shallowReactive, Fragment, nextTick, useSSRContext, createApp, renderList, useId, onErrorCaptured, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, useSlots, createTextVNode, createCommentVNode, withModifiers, getCurrentScope, markRaw } from 'vue';
import { s as serialize, p as parseQuery, h as createError$1, k as klona, j as defuFn, l as defu, m as hasProtocol, n as joinURL, o as getContext, q as isEqual, w as withQuery, r as withTrailingSlash, v as withoutTrailingSlash, x as isScriptProtocol, y as sanitizeStatusCode, z as withLeadingSlash, A as parseURL, $ as $fetch$1, B as baseURL, C as createHooks, D as executeAsync, E as toRouteMatcher, F as createRouter$1, G as encodeParam, H as encodePath } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "About",
    path: "/About",
    component: () => import('./About-D-Q2vN11.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-B31ST7OQ.mjs')
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import('./index-B61kYNuL.mjs')
  },
  {
    name: "blog-slug",
    path: "/blog/:slug()",
    component: () => import('./_slug_-BemDsXHm.mjs')
  },
  {
    name: "portfolio",
    path: "/portfolio",
    component: () => import('./index-CMAEP-bq.mjs')
  },
  {
    name: "portfolio-slug",
    path: "/portfolio/:slug()",
    component: () => import('./_slug_-_DrMR1dm.mjs')
  }
];
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-fvfLSLL7.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote--nnZ7mYB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-CrrYSNnS.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-CpN7dCHw.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-DFbWBEvr.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-Bnr7lSXL.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-Do_LxtFG.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-DfJVqIm_.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-BXDuDFEm.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-oTiw8Lj3.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-ClWC6UHJ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-Zh-M2QPE.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-BFUt3qN_.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-BdV2THwH.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-Dn-igZm5.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-BXarmtjs.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-BQ1cLaZF.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-BRRiFK3m.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-bRVapdGd.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-DCZg2KVs.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-BNqCsFKZ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-Ct8d74ae.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-B-M5Rrlp.mjs').then((r) => r["default"] || r.default || r));
...
const cfg0 = defineAppConfig({
  ui: {
    ...
    primary: "ui-primary",
    // Usa la variable --ui-primary definida en main.css
    gray: "slate"
    // Usa la paleta 'slate' de Tailwind para tonos neutros.
...
const layouts = {
  "blog-post": defineAsyncComponent(() => import('./blog-post-De6hBY2p.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-B-Lfvp_-.mjs').then((m) => m.default || m)),
  "portfolio-project": defineAsyncComponent(() => import('./portfolio-project-B7iCP7pq.mjs').then((m) => m.default || m))
};
...
const ipxRuntime$ZmaR6u5uC_gxqfmeZsnUW7sVtosYVlD7rDH6WZpmCS4 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipx"]: { provider: ipxRuntime$ZmaR6u5uC_gxqfmeZsnUW7sVtosYVlD7rDH6WZpmCS4, defaults: {} }
};
const useImage = () => {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-FfBdRTE2.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Bp7QE68D.mjs'));
...
export { _export_sfc as _, __nuxt_component_0 as a, useAsyncData as b, _sfc_main$b as c, useRoute as d, entry$1 as default, createError as e, __nuxt_component_0$2 as f, useAppConfig as g, useRuntimeConfig as h, tryUseNuxtApp as i, useButtonGroup as j, useComponentIcons as k, _sfc_main$c as l, _sfc_main$a as m, isArrayOfArray as n, get as o, _sfc_main$8 as p, pickLinkProps as q, _sfc_main$9 as r, __nuxt_component_2 as s, tv as t, useHead as u };
